    ...
    FLBuilder.registerModuleHelper('blog-posts', {
        ...
        init: function() {
            var form        = $('.fl-builder-settings'),
                ...
                field_type = form.find('select[name=show_custom_field]'),
            ...
            field_type.on('change', $.proxy( this._hideTypography, this ) );
        ...
        _hideTypography: function() {
            var form        = $('.fl-builder-settings'),
                ...
                field_type = form.find('select[name=show_custom_field]').val(),
            ...
            if( field_type == 'none' ) {
                form.find('#fl-field-layout_sort_order .uabb-sortable .custom_field').hide();
            } else {
                form.find('#fl-field-layout_sort_order .uabb-sortable .custom_field').show();
            }
        ...
        _togglePagination: function() {
            ...
            if( show_pagination == 'yes' && pagination == 'scroll' ) {
